...
export default function About() {
  ...
  return (
    <div>
      <img src="/static/images/truck.webp" alt="Fundraising" className="absolute right-[0%] top-[24.6%] cursor-pointer false w-[28%] h-auto" onClick={openModal} />
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <img src='/popup/about.webp' className='mx-auto h-auto max-w-[120%] pr-12' />
