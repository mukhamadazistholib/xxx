...
export default function Awards() {
  ...
  return (
    <div>
      <img src="/static/images/awards.webp" alt="Penghargaan Pak Anies" className="absolute bottom-[46%] left-0 z-[2] cursor-pointer false w-[20%] h-auto" onClick={openModal}/>
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                ...
                <div className="mt-4">
                  ...
                  <img src='/popup/awards-international.webp' className='mx-auto h-auto w-[130%]' />
