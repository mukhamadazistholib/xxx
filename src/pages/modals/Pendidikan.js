...
export default function Pendidikan() {
  ...
  return (
    <div>
     <img src="/static/images/bag.webp" alt="Fundraising" className="absolute bottom-[8%] right-[0%] cursor-pointer false w-[16%] h-auto" onClick={openModal}/>
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                ...
                <div className="mt-4">
                  ...
                  <img src='/popup/pendidikan.webp' className='mx-auto h-auto w-[130%]' />
