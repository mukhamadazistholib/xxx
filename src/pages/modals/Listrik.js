...
export default function Listrik() {
  ...
  return (
    <div>
        <img src="/static/images/lamp.webp" alt="Visi misi Pak Anies dan Cak Imin" className="absolute left-[26.2%] top-[0%] cursor-pointer false w-[12%] h-auto" onClick={openModal} />
